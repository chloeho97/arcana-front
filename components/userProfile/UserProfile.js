      ...
      if (userId) {
        try {
          const userResponse = await fetch(
            `https://arcana-back-two.vercel.app/users/${userId}`
          );
          ...
          if (currentUserId) {
            const connectionsResponse = await fetch(
              `https://arcana-back-two.vercel.app/users/connections/${currentUserId}`
            );
          ...
          if (likesData.result) {
            ...
            const topResponse = await fetch(
              `https://arcana-back-two.vercel.app/collections/top/${userId}`
            );
            ...
            const typeContent = await fetch(
              `https://arcana-back-two.vercel.app/elements/user/${userId}`
            );
  ...
  const handleFollowToggle = async () => {
    ...
    try {
      const res = await fetch(
        "https://arcana-back-two.vercel.app/users/follow",
        {
          method: "PUT",
    ...
    try {
      ...
      if (messageContent) {
        const messageRes = await fetch(
          "https://arcana-back-two.vercel.app/messages",
          {
            method: "POST",
            headers: { "Content-Type": "application/json" },
            body: JSON.stringify({
